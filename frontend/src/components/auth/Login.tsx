...
//         <h2 className="text-2xl font-bold text-white mb-6 text-center">登录 Arxiv Scout</h2>
...
//           还没有账号？{' '}
//           <button onClick={onRegisterClick} className="text-indigo-400 hover:text-indigo-300">
//             立即注册
//           </button>
//         </div>
//       </div>
